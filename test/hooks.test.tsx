...
import type { PopupState } from "../src/hooks";
import { usePopupState, anchorRef, bindMenu, bindPopper, bindPopover, bindTrigger, bindToggle, bindFocus, bindContextMenu } from "../src/hooks";
...
describe('usePopupState', () => {
  describe('bindMenu/bindTrigger', () => {
    ...
    const MenuTest = (): React.ReactNode => {
  ...
  describe('bindMenu/bindTrigger with anchorRef', () => {
    ...
    let divRef;
    const popupStates = [];
    let lastPopupState: PopupState = (null as any);
    beforeEach(() => {
    ...
    const MenuTest = (): React.ReactNode => {
      ...
      return <React.Fragment>
          ...
          <div ref={(c: HTMLElement | null | undefined) => {
          divRef = c;
  ...
  describe('bindToggle/bindPopper', () => {
    ...
    const PopperTest = (): React.ReactNode => {
      const popupState = usePopupState({
        popupId: 'popper',
        variant: 'popper'
      });
